...
- **Statistical similarity**: Kolmogorov-Smirnov, Chi-square тесты
- **Machine Learning Efficacy**: сравнение качества ML-моделей на реальных и синтетических данных
- **Privacy metrics**: оценка риска раскрытия информации
