        ...
        for i in range(self.epochs):
            for id_ in range(steps_per_epoch):
                ...
                for _ in range(ci):
                    ...
                    optimizerD.step()
                    epoch_d_loss.append((d_real + d_fake + pen).item())
            ...
            self.loss_history.append({
                'epoch': epoch,
                'discriminator_loss': np.mean(epoch_d_loss),
                'generator_loss': np.mean(epoch_g_loss)
            })
            epoch_d_loss = []
            epoch_g_loss = []                    
